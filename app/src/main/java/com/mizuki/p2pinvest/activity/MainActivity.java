package com.mizuki.p2pinvest.activity;
...
import com.mizuki.p2pinvest.common.ActivityManager;
import com.mizuki.p2pinvest.fragment.HomeFragment;
import com.mizuki.p2pinvest.fragment.InvestFragment;
import com.mizuki.p2pinvest.fragment.MeFragment;
import com.mizuki.p2pinvest.fragment.MoreFragment;
        ...
        switch (i) {
            case 0://首页
                if (homeFragment == null) {
                    //创建对象之后，并不会马上调用生命周期方法。而是在commit()之后，方才调用
...
//                tvMainHome.setTextColor(R.color.text_progress);//错误的写法
    ...
    public boolean onKeyUp(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK && flag) {
            Toast.makeText(this, "再点击一次退出当前程序", Toast.LENGTH_SHORT).show();
            flag = false;
            //发送延迟操作
    ...
    protected void onDestroy() {
        super.onDestroy();
        //方式一：
//        handler.removeMessages(1);//移除指定id的所有的消息
        //方式二：//移除所有的未被执行的消息
